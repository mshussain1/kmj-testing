                    ...
                    <div class="relative mr-4 sm:mr-12 lg:mr-32">
                        ...
                        <button
                            ...
                            <span
                                ...
                                :class="{ 'bg-blue-500 dark:bg-emerald-500' : year === '2020' }"></span>
                        </button>
                        <button
                            class="flex items-center justify-between font-medium text-gray-500 dark:text-gray-400 w-20 py-3 pr-2 text-left"
                            @click="year = '2019'">
                            ...
                            <span
                                class="block w-3.5 h-3.5 bg-gray-400 dark:bg-gray-700 border-2 border-white dark:border-gray-900 rounded-full"
                                :class="{ 'bg-blue-500 dark:bg-emerald-500' : year === '2019' }"></span>
                        </button>
                        <button
                            class="flex items-center justify-between font-medium text-gray-500 dark:text-gray-400 w-20 py-3 pr-2 text-left"
                            @click="year = '2018'">
                            ...
                            <span
                                class="block w-3.5 h-3.5 bg-gray-400 dark:bg-gray-700 border-2 border-white dark:border-gray-900 rounded-full"
                                :class="{ 'bg-blue-500 dark:bg-emerald-500' : year === '2018' }"></span>
                        </button>
                        <button
                            class="flex items-center justify-between font-medium text-gray-500 dark:text-gray-400 w-20 py-3 pr-2 text-left"
                            @click="year = '2017'">
                            ...
                            <span
                                class="block w-3.5 h-3.5 bg-gray-400 dark:bg-gray-700 border-2 border-white dark:border-gray-900 rounded-full"
                                :class="{ 'bg-blue-500 dark:bg-emerald-500' : year === '2017' }"></span>
                        </button>
                        <button
                            class="flex items-center justify-between font-medium text-gray-500 dark:text-gray-400 w-20 py-3 pr-2 text-left"
                            @click="year = '2016'">
                            ...
                            <span
                                class="block w-3.5 h-3.5 bg-gray-400 dark:bg-gray-700 border-2 border-white dark:border-gray-900 rounded-full"
                                :class="{ 'bg-blue-500 dark:bg-emerald-500' : year === '2016' }"></span>
                        </button>
                    </div>
                            ...
                            <article class="p-6 bg-white dark:bg-gray-800 shadow-2xl flex flex-col">
                                <header>
                                    <h3 class="h4 font-red-hat-display mb-1">
                                        <a href="#0">Launched Al Karbala Business</a>
                                    </h3>
                                </header>
