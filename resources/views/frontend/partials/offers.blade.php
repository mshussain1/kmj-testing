<section class="relative border-t border-gray-200 dark:border-gray-800"
    ...
    <div class="absolute inset-0 dark:opacity-25 bg-gradient-to-b dark:from-gray-800 dark:to-gray-900 pointer-events-none"
        aria-hidden="true"></div>
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div class="py-12 md:py-20">
            <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h2 class="h2 font-red-hat-display">Welcome to the world of real innovation</h2>
                <span>We take pride in offering</span>
            </div>
            <div class="max-w-xs mx-auto sm:max-w-none md:max-w-xl lg:max-w-none grid sm:grid-cols-2 gap-4 lg:gap-6 lg:grid-cols-4"
                data-aos-id-featbl>

                <!-- 1st item -->
                <a class="flex flex-col p-5 group text-white bg-gradient-to-tr from-teal-500 to-teal-400 dark:to-teal-500 shadow-2xl"
                    ...
                    <div class="font-red-hat-display text-xl font-extrabold tracking-tighter mb-1">Paperless procurement
                    </div>

                    <svg class="w-6 h-6 self-end transform -translate-x-2 group-hover:translate-x-0 transition duration-150 ease-in-out"
                ...
                <!-- 2nd item -->
                <a class="flex flex-col p-5 group text-white bg-gradient-to-tr from-purple-500 to-purple-400 dark:to-purple-500 shadow-2xl"
                    ...
                    <div class="font-red-hat-display text-xl font-extrabold tracking-tighter mb-1">Automated Solution
                    </div>
                ...
                <!-- 3rd item -->
                <a class="flex flex-col p-5 group text-white bg-gradient-to-tr from-indigo-500 to-indigo-400 dark:to-indigo-500 shadow-2xl"
                    ...
                    <div class="font-red-hat-display text-xl font-extrabold tracking-tighter mb-1">
                ...
                <!-- 4th item -->
                <a class="flex flex-col p-5 group text-white bg-gradient-to-tr from-pink-500 to-pink-400 dark:to-pink-500 shadow-2xl"
                    ...
                    <div class="font-red-hat-display text-xl font-extrabold tracking-tighter mb-1">Free Registration
                    </div>
